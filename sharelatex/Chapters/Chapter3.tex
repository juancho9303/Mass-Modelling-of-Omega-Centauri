...
For stars in the cluster, one must choose a very small aperture of the sky because the surrounding stars contribute to the flux that needs to be extracted, for the size of the aperture containgin each star I chose an aperture size of three times the FWHM (calculated for some stars pressing "a" with the imexamine task) and for the 
