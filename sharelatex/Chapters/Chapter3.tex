...
\textit{\textbf{Figure:}} OPD observatory seen from the air, the big dome was used for the spectroscopic data and the small dome at the low right part of the photo for the photometric data. 
\end{center}
...
\textit{\textbf{Figure:}} Organized globular Clusters in groups for the proper times. 
\end{center}
...
\begin{center}
\includegraphics[scale=0.3]{images/opd-photometry.jpg}

\textit{\textbf{Figure:}} IAG telescope used for the photometric data
\end{center}
