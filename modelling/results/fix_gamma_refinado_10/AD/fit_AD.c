...
int main(int argc, char *argv[])
{
  ...
  as_ini     = 56.0;        as_end     = 60.0;     Delta_as     = 0.2;
  Mdm_ini    = 14.0;        Mdm_end    = 18.0;     Delta_Mdm    = 0.2;
  Ms_ini     = 20.0;        Ms_end     = 24.0;     Delta_Ms     = 0.2;
  beta_ini   = 0.1;         beta_end   = 0.3;      Delta_beta   = 0.02;
