...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 1.5;        gamma_end  = 1.9;      Delta_gamma  = 0.08;
  adm_ini    = 9.0;        adm_end    = 13.0;     Delta_adm    = 0.08;
  Mdm_ini    = 0.8;        Mdm_end    = 1.2;      Delta_Mdm    = 0.08;
  Ms_ini     = 9.0;        Ms_end     = 13.0;     Delta_Ms     = 0.08;
  beta_ini   = 0.0001;     beta_end   = 0.0005;   Delta_beta   = 0.00008;
