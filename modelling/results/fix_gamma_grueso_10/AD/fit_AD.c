...
int main(int argc, char *argv[])
{
  ...
  adm_ini    = 1.0;        adm_end    = 60.0;     Delta_adm    = 3.0;
  as_ini     = 1.0;        as_end     = 60.0;     Delta_as     = 3.0;
  Mdm_ini    = 1.0;        Mdm_end    = 80.0;     Delta_Mdm    = 3.0;
  Ms_ini     = 1.0;        Ms_end     = 80.0;     Delta_Ms     = 3.0;
  beta_ini   = 0.001;      beta_end   = 1.0;      Delta_beta   = 0.3;
