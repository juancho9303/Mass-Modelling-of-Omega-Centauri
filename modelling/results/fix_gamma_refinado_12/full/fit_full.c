...
int main(int argc, char *argv[])
{
  ...
  adm_ini    = 20.0;      adm_end    = 24.0;     Delta_adm    = 0.2;
  as_ini     = 41.0;      as_end     = 45.0;     Delta_as     = 0.2;
  Mdm_ini    = 5.0;       Mdm_end    = 9.0;      Delta_Mdm    = 0.2;
  Ms_ini     = 0.8;       Ms_end     = 1.2;      Delta_Ms     = 0.2;
  beta_ini   = 0.7;       beta_end   = 1.1;      Delta_beta   = 0.02;
