...
int main(int argc, char *argv[])
{
  ...
  M_s = 66.1;   //STELLAR MASS OF 6.61e6 M_sun
  
  // THE VARIATIONS OF THE PARAMETERS

  gamma_ini  = 2.1;        gamma_end  = 2.5;      Delta_gamma  = 0.05;
  adm_ini    = 54.0;        adm_end    = 58.0;     Delta_adm    = 0.05;
  Mdm_ini    = 0.8;        Mdm_end    = 1.2;     Delta_Mdm    = 0.05;
  beta_ini   = 0.6;     beta_end   = 1.0;      Delta_beta   = 0.05;
