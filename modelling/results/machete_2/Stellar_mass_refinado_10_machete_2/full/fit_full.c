...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 2.1;        gamma_end  = 2.3;      Delta_gamma  = 0.09;
  adm_ini    = 18.0;        adm_end    = 20.0;     Delta_adm    = 0.09;
  as_ini     = 53.0;        as_end     = 55.0;     Delta_as     = 0.09;
  Mdm_ini    = 18.0;        Mdm_end    = 20.0;     Delta_Mdm    = 0.09;
  beta_ini   = 0.3;     beta_end   = 0.5;      Delta_beta   = 0.09;
