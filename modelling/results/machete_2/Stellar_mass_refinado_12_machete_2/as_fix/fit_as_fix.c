...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 0.1;        gamma_end  = 0.3;      Delta_gamma  = 0.04;
  adm_ini    = 15.0;        adm_end    = 17.0;     Delta_adm    = 0.04;
  Mdm_ini    = 5.0;        Mdm_end    = 7.0;     Delta_Mdm    = 0.04;
  beta_ini   = 0.7;     beta_end   = 0.9;      Delta_beta   = 0.04;
