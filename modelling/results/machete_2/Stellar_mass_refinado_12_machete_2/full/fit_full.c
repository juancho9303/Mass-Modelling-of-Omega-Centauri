...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 1.2;        gamma_end  = 1.4;      Delta_gamma  = 0.08;
  adm_ini    = 18.0;        adm_end    = 20.0;     Delta_adm    = 0.08;
  as_ini     = 48.0;        as_end     = 50.0;     Delta_as     = 0.08;
  Mdm_ini    = 18.0;        Mdm_end    = 20.0;     Delta_Mdm    = 0.08;
  beta_ini   = 0.8;     beta_end   = 1.0;      Delta_beta   = 0.08;
