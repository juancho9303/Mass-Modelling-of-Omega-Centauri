...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 1.7;       gamma_end  = 2.1;      Delta_gamma  = 0.2;
  adm_ini    = 9;       adm_end    = 13.0;     Delta_adm    = 0.2;
  as_ini     = 54.0;       as_end     = 58.0;     Delta_as     = 0.2;
  Mdm_ini    = 4.0;        Mdm_end    = 8.0;     Delta_Mdm    = 0.2;
  Ms_ini     = 9.0;        Ms_end     = 13.0;     Delta_Ms     = 0.2;
  beta_ini   = 0.001;        beta_end   = 0.05;      Delta_beta   = 0.01;
