...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 0.08;       gamma_end  = 1.2;      Delta_gamma  = 0.06;
  adm_ini    = 14.0;       adm_end    = 18.0;     Delta_adm    = 0.6;
  as_ini     = 49.0;       as_end     = 53.0;     Delta_as     = 0.6;
  Mdm_ini    = 9.0;        Mdm_end    = 13.0;     Delta_Mdm    = 0.6;
  Ms_ini     = 9.0;        Ms_end     = 13.0;     Delta_Ms     = 0.6;
  beta_ini   = 0.4;        beta_end   = 0.8;      Delta_beta   = 0.06;
