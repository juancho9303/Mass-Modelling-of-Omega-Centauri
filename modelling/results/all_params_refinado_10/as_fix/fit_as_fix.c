...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 2.1;        gamma_end  = 2.5;      Delta_gamma  = 0.1;
  adm_ini    = 54.0;        adm_end    = 58.0;     Delta_adm    = 0.1;
  Mdm_ini    = 0.8;        Mdm_end    = 1.2;      Delta_Mdm    = 0.1;
  Ms_ini     = 34.0;        Ms_end     = 38.0;     Delta_Ms     = 0.1;
  beta_ini   = 0.6;        beta_end   = 1.0;   Delta_beta   = 0.01;
