...
int main(int argc, char *argv[])
{
  ...
  M_s = 49.6;   //STELLAR MASS OF 6.61e6 M_sun
  
  // THE VARIATIONS OF THE PARAMETERS

  gamma_ini  = 1.0;        gamma_end  = 1.2;      Delta_gamma  = 0.02;
  adm_ini    = 55.0;        adm_end    = 57.0;     Delta_adm    = 0.02;
  Mdm_ini    = 0.9;        Mdm_end    = 1.1;     Delta_Mdm    = 0.02;
  beta_ini   = 0.7;     beta_end   = 0.9;      Delta_beta   = 0.02;
