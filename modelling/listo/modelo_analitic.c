...
*/
  ...
  double M_steM_dm = -(((1.61676 + r)*(1.28859 + r*(1.88324 + r)))/(pow(1.0 + r,4))) + log((1.0+r)/r);
  
  double M_dmM_ste = -(((1.61676 + r)*(1.28859 + r*(1.88324 + r)))/(pow(1.0 + r,4))) + log((1.0+r)/r);
  ...
  double tot = alfa*(M_steM_ste + M_dmM_dm + M_steM_dm + M_dmM_ste);
