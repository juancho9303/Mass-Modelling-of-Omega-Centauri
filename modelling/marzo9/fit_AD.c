...
int main(int argc, char *argv[])
{
  ...
  Mdm_ini    = 0.00001;    Mdm_end    = 0.0008;   Delta_Mdm    = 0.0002;
  Ms_ini     = 0.00001;    Ms_end     = 0.0008;   Delta_Ms     = 0.0002;
  ...
  printf("xi = %16.8lf\t beta = %16.8lf\t a_dm/pc = %16.8lf\t a_s/pc = %16.8lf\n M_dm/Msun = %16.8elf\t M_s/Msun = %16.8e\t gamma = %lf\n",
