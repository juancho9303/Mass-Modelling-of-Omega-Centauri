...
int main(int argc, char *argv[])
{
  ...
  gamma_ini  = 1.0;        gamma_end  = 1.6;      Delta_gamma  = 0.08;
  a_ini      = 1.0;        a_end      = 7.0;      Delta_a      = 0.08;
  M_ini      = 19.0;       M_end      = 25.0;     Delta_M      = 0.08;
  beta_ini   = 0.1;        beta_end   = 0.7;      Delta_beta   = 0.08;
