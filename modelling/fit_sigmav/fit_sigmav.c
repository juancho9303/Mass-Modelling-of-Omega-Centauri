...
int main(int argc, char *argv[])
{
  ...
  adm_ini    = 0.005;      adm_end    = 0.06;     Delta_adm    = 0.01;
  as_ini     = 0.005;      as_end     = 0.06;     Delta_as     = 0.01;
  Mdm_ini    = 0.00001;    Mdm_end    = 0.0008;   Delta_Mdm    = 0.0001;
  Ms_ini     = 0.00001;    Ms_end     = 0.0008;   Delta_Ms     = 0.0001;
  //beta_ini   = 0.00001;    beta_end   = 0.0008;   Delta_Ms     = 0.0001;
  
  // HAGO LAS VARIACIONES DE LOS PARAMETROS
  beta  =  0.0001;
  
  int Ntotal_iterations, counter;
  Ntotal_iterations = (int) ( ((gamma_end-gamma_ini)/Delta_gamma)*((adm_end-adm_ini)/Delta_adm)*((as_end-as_ini)/Delta_as)*((Mdm_end-Mdm_ini)/Delta_Mdm)*((Ms_end-Ms_ini)/Delta_Ms) );
  ...
  printf("xi=%16.8lf a_dm/pc=%16.8lf a_s/pc=%16.8lf M_dm/Msun=%16.8elf M_s/Msun=%16.8e gamma=%lf\n",
	 chi_min, 1000*a_dm_min, 1000*a_s_min, (1.0e10)*M_dm_min, (1.0e10)*M_s_min, gamma_min);
