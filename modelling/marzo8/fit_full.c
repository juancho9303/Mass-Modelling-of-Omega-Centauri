...
int main(int argc, char *argv[])
{
  ...
  adm_ini    = 0.001;      adm_end    = 0.06;     Delta_adm    = 0.02;
  as_ini     = 0.001;      as_end     = 0.06;     Delta_as     = 0.02;
  Mdm_ini    = 0.00001;    Mdm_end    = 0.0008;   Delta_Mdm    = 0.0003;
  Ms_ini     = 0.00001;    Ms_end     = 0.0008;   Delta_Ms     = 0.0003;
  beta_ini   = 0.00001;    beta_end   = 1.0;      Delta_beta   = 0.5;
		      ...
		      for(M_dm = Mdm_ini; M_dm < Mdm_end;  M_dm = M_dm + Delta_Mdm)
			{
			  for(M_s = Ms_ini; M_s < Ms_end;  M_s = M_s + Delta_Ms)
			      ...
			      for(i = 0; i < K; i ++)          
				{
			      ...
			      gsl_interp_accel *acc  =   gsl_interp_accel_alloc ();
			      gsl_spline *spline     =   gsl_spline_alloc (gsl_interp_linear, 90);
