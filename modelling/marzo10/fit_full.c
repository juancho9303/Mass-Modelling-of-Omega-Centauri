...
#define G 430.071            //unidades de Gadget
...
int main(int argc, char *argv[])
{
  ...
  adm_ini    = 1.0;      adm_end    = 60.0;     Delta_adm    = 10.0;
  as_ini     = 1.0;      as_end     = 60.0;     Delta_as     = 10.0;
  Mdm_ini    = 1.0;    Mdm_end    = 80.0;   Delta_Mdm    = 10.0;
  Ms_ini     = 1.0;    Ms_end     = 80.0;   Delta_Ms     = 10.0;
