...
int main(){
  ...
  beta  =  0.000001;    
  //3.50000000e-02           5.50000000e-02          1.00000000e-05   3.00000000e-04
//2.50000000e-02           1.50000000e-02          1.00000000e-05   1.00000000e-04
//  2.50000000e-02           5.50000000e-02          6.10000000e-04   1.00000000e-04
//  1.50000000e-02           5.50000000e-02          1.00000000e-05          1.00000000e-04
...
*/		      
			...
			{                                     
			  ...
			  sig_p = sqrt(((G)/(GAMMA*(I_R)*M_PI))*re1); //Sigma proyectada
			  //printf("%16.8e\t %16.8e\n", R, I_R);
			  fprintf(mod,"%16.8e\t %16.8e\n", R/(4.80839)*3437.75, sig_p);
			}		  
		      //gsl_integration_workspace_free(z);
		      //fprintf(mod,"# a_dm=%16.8e\t a_s=%16.8e\t M_dm=%16.8e\t M_s=%16.8e\n", a_dm, a_s, M_dm, M_s);
