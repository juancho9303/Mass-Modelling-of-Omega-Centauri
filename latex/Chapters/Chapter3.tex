...
- Divide the Superflats by the median: In order to normalize the flatfields we find the mode of each frame with \textit{imstatistics} and then divide them by that value using \textit{imarith}. An example of the normalized superflat at this point of the procedures is shown in figure 3.6.
...
As further reference, we searched for reported values of the dynamical mass of $\omega$ Centauri, in table 3.4 
