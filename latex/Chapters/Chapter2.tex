...
We will assume that the stellar systems that we will study are colisionless. This assumption not only reduces the problem of determining the functional form of the position and velocities of the stars but also has strong physical reasons. That must  be mentioned.

We use the approximation that the calculations of the orbits of stars could be determined by assuming that the mass of the GC is distributed smoothly in space, rather than concentrated in certain positions as point masses. We can easily use this approximation since 
