...
As will be mentioned in the modelling chapter, we focus on the Hernquist model. In order to introduce the model as done by Lars Hernquist in 1989 with his article ``An analytical model for spherical galaxies and bulges" let's start by considering the density profile
