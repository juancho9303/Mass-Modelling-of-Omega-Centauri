...
As we mentioned in the last chapter, we used many databases for projected radial velocities in order to properly do our fit and modelling. The radial velocities as a function of the projected radius are shown in figure 4.1
...
Experiment 23 shows a very bad fitting of the curve so the results of the parameters are not even worth mentioning. In the case of experiment 24 the fitting is quite good so we can analyse the values of the parameters found with the minimization technique and table 4.11
