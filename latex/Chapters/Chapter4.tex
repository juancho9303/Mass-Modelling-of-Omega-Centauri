...
In this set of experiments we do the variation of all the parameters and we use the whole sample of 12 velocity dispersions to be fitted. The results are summarized in figure 4.8 and table 4.1.
...
We vary all the parameters except for the mass to light ratio $\Gamma$ that, as we just showed, has a value of $2.5$ and we use 12 points to fit the model. The results are summarized in figure 4.10 and table 4.3.
...
Again, we set the mass-to-light ratio to $2.5$ and vary the rest of the parameters. This time we use 10 outer points to fit our model. The results are summarized in figure 4.11 and table 4.4.
...
\subsection{Fix stellar mass including the inner region of the cluster}
 ...
 summarized in figure 4.12 and table 4.5 (for the 12 radial bins)
...
the results given in figure 4.13 and table 4.6
...
For the 12 radial bins the results are shown in figure 4.14 and table 4.7.
...
And finally, for the 10 outer radial bins, we have the results of the best fits shown in figure 4.15 and table 4.8
